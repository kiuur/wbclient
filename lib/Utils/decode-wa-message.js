//=======================================================//
import { areJidsSameUser, isJidBroadcast, isJidGroup, isJidHostedLidUser, isJidHostedPnUser, isJidMetaAI, isJidNewsletter, isJidStatusBroadcast, isLidUser, isPnUser } from "../WABinary/index.js";
      ...
      if (Array.isArray(stanza.content)) {
        for (const { tag, attrs, content } of stanza.content) {
          ...
          try {
            ...
            let msg = decodeAndHydrate(proto.Message, e2eType !== "plaintext" ? unpadRandomMax16(msgBuffer) : msgBuffer);
