...
export const PROCESSABLE_HISTORY_TYPES = [
  proto.Message.HistorySyncNotification?.INITIAL_BOOTSTRAP,
  proto.Message.HistorySyncNotification?.PUSH_NAME,
  proto.Message.HistorySyncNotification?.RECENT,
  proto.Message.HistorySyncNotification?.FULL,
  proto.Message.HistorySyncNotification?.ON_DEMAND
].filter(Boolean);
//===================================//
